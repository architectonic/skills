---
name: Validating TPM Measured Boot and Attestation
description: Verify TPM PCRs and measured-boot and remote-attestation integrity.
tags: [devops, agent-skill, okf, hardware-firmware-security, tpm, measured-boot, remote-attestation, pcr, tpm2-tools, integrity-verification, trusted-computing, security]
license: Apache-2.0
type: Playbook
---
