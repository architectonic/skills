...
tags: [software-development, software-development, agent-skill, okf, csp-bypass, content-security-policy, xss, script-injection, nonce-bypass, jsonp, policy-misconfiguration, security]
license: Apache-2.0
type: Playbook
---
