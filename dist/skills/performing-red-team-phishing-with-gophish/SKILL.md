---
name: For authorized penetration testing and lab environments only
description: Automate GoPhish phishing simulation campaigns using the Python gophish
tags: [software-development, software-development, agent-skill, okf, red-teaming, phishing-simulation, gophish, social-engineering, campaign-automation, security-awareness, security]
license: Apache-2.0
type: Playbook
---
