---
name: Implementing Canary Tokens for Network Intrusion Detection
description: Deploys DNS, HTTP, and AWS API key canary tokens across network infrastructure
tags: [software-development, software-development, agent-skill, okf, canary-tokens, intrusion-detection, deception, network-security, honeytokens, breach-detection, security]
license: Apache-2.0
type: Playbook
---
