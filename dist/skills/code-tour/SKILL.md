...
tags: [agent-operations, code-tour, onboarding, documentation, walkthrough, vscode]
type: Playbook
---
...
Distilled from claude-skills (`.gemini/skills/code-tour`), MIT license.
...
- Related: `software-development/codebase-onboarding` — for broader onboarding beyond tours
- Related: `software-development/pr-review-expert` — for automated PR review workflows
