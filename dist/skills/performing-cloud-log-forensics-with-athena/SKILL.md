---
name: Performing Cloud Log Forensics with AWS Athena
description: Uses AWS Athena to query CloudTrail, VPC Flow Logs, S3 access logs,
tags: [software-development, software-development, agent-skill, okf, cloud, forensics, athena, aws, cloudtrail, vpc-flow-logs, s3, alb, security]
license: Apache-2.0
type: Playbook
---
