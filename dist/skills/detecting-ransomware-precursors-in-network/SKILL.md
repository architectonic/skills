---
name: Detecting Ransomware Precursors in Network Traffic
description: Detects early-stage ransomware indicators in network traffic before
tags: [software-development, software-development, agent-skill, okf, ransomware, detection, network-security, incident-response, defense, security]
license: Apache-2.0
type: Playbook
---
