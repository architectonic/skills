...
Takes error analysis data (ideally from error-monitoring) and generates optimized alert rules, severity tiers, escalation policies, and on-call runbooks. Turns a noisy alerting setup into a structured incident response system.

## When to Use

- Reducing alert noise / alert fatigue
- Creating or restructuring alert rules
- Setting up escalation policies
- Tuning alerting thresholds
- Creating on-call runbooks
- Defining severity tiers for a monitoring platform
