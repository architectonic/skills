---
name: Scanning Network with Nmap Advanced Techniques
description: Performs advanced network reconnaissance using Nmap''s scripting engine,
tags: [software-development, software-development, agent-skill, okf, network-security, nmap, port-scanning, service-enumeration, reconnaissance, security]
license: Apache-2.0
type: Playbook
---
