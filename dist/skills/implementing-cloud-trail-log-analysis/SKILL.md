---
name: Implementing CloudTrail Log Analysis
description: Implementing AWS CloudTrail log analysis for security monitoring, threat
tags: [software-development, software-development, agent-skill, okf, cloud-security, aws, cloudtrail, log-analysis, threat-detection, forensics, security]
license: Apache-2.0
type: Playbook
---
